...
game.SpendGold = Object.extend({
    ...
    update: function(){
        ...
        if(me.input.isKeyPressed("buy") && this.now-this.lastBuy >=100){
    ...
    checkBuyKeys: function() {
        if(me.input.isKeyPressed("F1")){
            if(me.input.checkCost(1)){
                this.makePurchase(1);
            }
        }else if(me.input.isKeyPressed("F2")){
     if(me.input.checkCost(2)){
                this.makePurchase(2);
            }
        }else if(me.input.isKeyPressed("F3")){
         if(me.input.checkCost(3)){
                this.makePurchase(3);
            }
        }else if(me.input.isKeyPressed("F4")){
     if(me.input.checkCost(4)){
                this.makePurchase(4);
            }
        }else if(me.input.isKeyPressed("F5")){
         if(me.input.checkCost(5)){
                this.makePurchase(5);
            }
        }else if(me.input.isKeyPressed("F6")){
         if(me.input.checkCost(6)){
                this.makePurchase(6);
            }
    }
    },
