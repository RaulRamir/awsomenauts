game.PlayerEntity = me.Entity.extend({
    ...
    update: function(delta) {
        ...
        if (me.input.isKeyPressed("right")) {
            ...
            //setVelocity()and multiplying it be me.timer.tick
            //me.timer.tick makes the movement look move
        ...
        if (me.input.isKeyPressed("attack")) {
            if (!this.renderable.isCurrentAnimation("attack")) {
                ...
                //sets the current animation to attack and when its over
                //goes back to current animation
                this.renderable.setCurrentAnimation("attack");
                //makes it so that the next time we start this sequence we begin
                //from the first animation, not wherever we left off to another animation
...
game.PlayerBaseEntity = me.Entity.extend({
    init: function(x, y, settings) {
        ...
        this.broken = false;
        this.health = game.dataBaseHealth;
